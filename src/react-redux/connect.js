...
const useIsomorphicLayoutEffectWithArg = (effectFunc, effectArgs, dependencies) => useLayoutEffect(() => effectFunc(...effectArgs), [effectFunc, effectArgs, dependencies])
...
export default function wrapWithConnect(WrappedComponent) {
  ...
  function ConnectFunction(props) {
    ...
    useIsomorphicLayoutEffectWithArg(captureWrapperProps, [lastWrapperProps, lastChildProps, renderIsScheduled, props, actualChildProps, childPropsFromStoreUpdate, notifyNestedSubs])
    useIsomorphicLayoutEffectWithArg(subscribeUpdates, [store, subscription, childPropsSelector, lastWrapperProps, lastChildProps, renderIsScheduled, childPropsFromStoreUpdate, notifyNestedSubs, forceComponentUpdateDispatch], [store, subscription, childPropsSelector])
